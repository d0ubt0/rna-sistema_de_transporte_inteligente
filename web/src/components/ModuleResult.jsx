    ...
    <div className="space-y-6 animate-fade-in-up">
      <div className="glass rounded-3xl p-8 glow-brand">
        ...
        <p className="text-sm text-surface-200/40 mb-6">
          Días 1–30: demanda real (contexto) · Días 31–60: demanda real vs predicción de la red neuronal
        </p>
        ...
        <div className="h-72 sm:h-80">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={days} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
              ...
              <ReferenceLine x={30.5} stroke="#ebdbb2" strokeDasharray="4 4" strokeWidth={1.5} label={{ value: 'Comparación →', position: 'insideTopRight', fill: '#ebdbb2', fontSize: 11 }} />
              <XAxis
                dataKey="day"
              ...
              <Legend
                ...
                formatter={(value) => (
                  <span style={{ color: '#ebdbb2' }}>
                    {value === 'real' ? 'Demanda Real' : 'Predicción IA'}
                  </span>
                )}
              />
              <Area
